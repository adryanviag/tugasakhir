            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-success">
                        ...
                        <form method="post" enctype="multipart/form-data" action="/suratmasuk/disposisi">
                            @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mt-2 col-md-6">
                                            ...
                                            <select readonly="readonly" class="custom-select form-control-border mb-2"
                                                name="PengirimInstansi" aria-label="Default select example">
                            ...
                            <input hidden type="text" value="{{ auth()->user()->unit->Kode }}" name="Pengirim">
                            <input hidden value="<?php echo date('Y-m-d'); ?>" name="TglDisposisi" readonly="readonly" type="date"
                                class="form-control">
                            <div class="card card-secondary">
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <select id="sm_select" class="form-control-border custom-select mb-2"
                                                ...
                                                <option selected value="Didisposisikan">Didisposisikan</option>
